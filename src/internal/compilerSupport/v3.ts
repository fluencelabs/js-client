...
type ScalarNames = 'u8' | 'u16' | 'u32' | 'u64' | 'i8' | 'i16' | 'i32' | 'i64' | 'f32' | 'f64' | 'bool' | 'string';
...
type CallbackArrowType = ArrowType<LabeledProductType<NonArrowType | ArrowType<LabeledProductType<NonArrowType>>>>;
...
interface ServiceDef {
     ...
     */
    functions: LabeledProductType<NonArrowType>;
}
        ...
        for (let i = 0; i < argsDefLength; i++) {
            ...
            const [serviceId, fnName, cb] = match(argDefType)
                ...
                .with({ tag: 'arrow' }, (callbackDef) => {
                    ...
                    return [def.names.callbackSrv, argDefName, fn] as const;
                })
                ...
                .with({ tag: 'option' }, () => {
                    ...
                    return [def.names.getDataSrv, argDefName, fn] as const;
                })
