...
function newImportObject(registry: ServiceRegistry, cfg: HostImportsConfig, peerId: PeerId): ImportObject {
    return {
        ...
        './aquamarine_client_bg.js': {
            ...
            __wbg_callserviceimpl_94e62d12c5d03766: (arg0: any, arg1: any, arg2: any, arg3: any, arg4: any, arg5: any, arg6: any, arg7: any, arg8: any) => {
                ...
                try {
                    ...
                    let serviceResult = service(registry, serviceId, fnName, args, tetraplets);
...
export async function instantiateInterpreter(registry: ServiceRegistry, peerId: PeerId): Promise<InterpreterInvoke> {
    let cfg = new HostImportsConfig((cfg) => {
        return newImportObject(registry, cfg, peerId);
    });
