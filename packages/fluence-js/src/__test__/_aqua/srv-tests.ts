                    ...
                    (xor
                     (seq
                      (seq
                       (call %init_peer_id% ("getDataSrv" "-relay-") [] -relay-)
                       (xor
                        (call %init_peer_id% ("single_module_srv" "remove") ["random_id"])
                        (null)
                       )
                      )
                      (xor
                    ...
                    (xor
                     (seq
                      (seq
                       (call %init_peer_id% ("getDataSrv" "-relay-") [] -relay-)
                       (xor
                        (call %init_peer_id% ("single_module_srv" "read_file") ["/random/incorrect/file"] wasm)
                        (null)
                       )
                      )
                      (xor
                       ...
                       (seq
                        (seq
                         (seq
                          ...
                          (call %init_peer_id% ("single_module_srv" "create") [wasm])
                         )
                         (call %init_peer_id% ("single_module_srv" "create") [wasm])
                        )
                        (call %init_peer_id% ("single_module_srv" "create") [wasm])
