...
//     callFunctionEx(peer, def, script, args, config);
// }

export const callFunctionEx = (
    peer: FluencePeer,
    def: FunctionCallDef,
    script: string,
    args: any[],
...
//     args: any[];
// } => {
//     const numberOfExpectedArgs = getArgumentTypes(def).length;
...
const getArgumentTypes = (def: FunctionCallDef) => {
    ...
    return Object.entries(def.arrow.domain.fields);
};
